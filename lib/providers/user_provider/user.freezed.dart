...
mixin _$User {
  @JsonKey(name: '_id')
  String get userId =>
      throw _privateConstructorUsedError; // Use userId instead of _id
...
// required String password,
  ...
  @override
  String toString() {
    return 'User(userId: $userId, firstName: $firstName, lastName: $lastName, username: $username, email: $email, phoneNumber: $phoneNumber, country: $country, userRole: $userRole, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, userId, firstName, lastName,
      username, email, phoneNumber, country, userRole, createdAt, updatedAt);
...
abstract class _User implements User {
  ...
  @JsonKey(name: '_id')
  String get userId;
  @override // Use userId instead of _id
